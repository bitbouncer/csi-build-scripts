...
wget --no-check-certificate https://dist.apache.org/repos/dist/dev/avro/avro-1.8.0-rc1/avro-src-1.8.0.tar.gz -Oavro-src-1.8.0.tar.gz
gunzip avro-src-1.8.0.tar.gz
tar xf avro-src-1.8.0.tar
del avro-src-1.8.0.tar
mkdir avro-src-1.8.0\lang\c++\avro
xcopy /s /y avro-src-1.8.0\lang\c++\api\* avro-src-1.8.0\lang\c++\avro
